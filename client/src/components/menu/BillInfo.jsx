    ...
    try {
      ...
      if (paymentMethod === "Cash") {
        const orderRes = await axios.post(
          "https://pos-server-phi.vercel.app/api/v1/order/create",
          {
            customerDetails: {
        ...
        await axios.post(
          `https://pos-server-phi.vercel.app/api/v1/table/update/${table.tableId}`,
          {
            status: "Booked",
      ...
      if (paymentMethod === "Online") {
        ...
        const { data } = await axios.post(
          "https://pos-server-phi.vercel.app/api/v1/payment/create-order",
        ...
        const options = {
          ...
          handler: async function (response) {
            try {
              await axios.post(
                "https://pos-server-phi.vercel.app/api/v1/payment/verify-payment",
                response,
                { withCredentials: true },
              );
